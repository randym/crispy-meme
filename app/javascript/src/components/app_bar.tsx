...
<Typography
          ...
          href="/cities"
          variant="small"
          className="flex items-center gap-x-2 p-1 font-medium border-grey-500 border-2 rounded"
        >
          <svg
            width="16"
            height="15"
  ...
  return (
    <Navbar
      variant="gradient"
      color="blue-gray"
      className="fixed top-0 z-50 flex flex-col sm:flex-row gap-4 rounded-none justify-between from-blue-gray-900 to-blue-gray-800 px-4 py-2"
    >
